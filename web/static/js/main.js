...
var _simonh1000$elm_charts$ChartModel$initItems = _elm_lang$core$List$map(
	_elm_lang$core$Basics$uncurry(_simonh1000$elm_charts$ChartModel$initItem));
var _simonh1000$elm_charts$ChartModel$chartInit = F2(
	function (vs, typ) {
		return {
			chartType: typ,
			items: _simonh1000$elm_charts$ChartModel$initItems(vs),
			width: 400,
			height: 300,
			title: '',
			colours: {
...
var _simonh1000$elm_charts$ChartModel$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {chartType: a, items: b, width: c, height: d, title: e, colours: f, styles: g};
	});
...
var _simonh1000$elm_charts$LineChart$viewLine = function (model) {
	...
	var chartH = (_elm_lang$core$Basics$toFloat(model.height) / 2) - 40;
	var chartW = (_elm_lang$core$Basics$toFloat(model.width) / 2) - 30;
	var yaxis = {
		ctor: '::',
		_0: A2(
			_evancz$elm_graphics$Collage$traced,
...
var _simonh1000$elm_charts$Chart$viewPie = function (model) {
	...
	var go = F2(
		function (val, _p2) {
			...
			if (_p4.ctor === '::') {
				var _p5 = _p4._1;
				var ang = (((val.normValue / 100) * 2) * _elm_lang$core$Basics$pi) * 16;
				return {
					ctor: '_Tuple3',
					_0: _p7 - ang,
...
var _simonh1000$elm_charts$Chart$dimensions = F3(
...
var _user$project$Components_ChartView$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: _simonh1000$elm_charts$Chart$toHtml(
				A2(
					...
					'Dropper Post Eval',
					_simonh1000$elm_charts$Chart$vBar(model))),
			_1: {ctor: '[]'}
		});
};
var _user$project$Components_ChartView$update = F2(
	function (msg, model) {
...
var _user$project$Components_PriceMeasure$update = F2(
	function (_p0, model) {
		var _p1 = _p0;
		return {
			ctor: '_Tuple2',
...
var _user$project$Components_PriceMeasure$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
											...
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_user$project$Components_PriceMeasure$Changed),
															_1: {ctor: '[]'}
														}
													}
												}
...
var _user$project$Components_ReliabilityMeasure$update = F2(
	function (_p0, model) {
		var _p1 = _p0;
		return {
			ctor: '_Tuple2',
...
var _user$project$Components_ReliabilityMeasure$Model = F4(
	function (a, b, c, d) {
		return {label: a, attribute: b, weight: c, score: d};
	});
var _user$project$Components_ReliabilityMeasure$initialModel = A4(_user$project$Components_ReliabilityMeasure$Model, 'Reliability', 'reliability', 5, 0.0);
var _user$project$Components_ReliabilityMeasure$Changed = function (a) {
	return {ctor: 'Changed', _0: a};
};
var _user$project$Components_ReliabilityMeasure$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
											...
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_user$project$Components_ReliabilityMeasure$Changed),
															_1: {ctor: '[]'}
														}
													}
												}
...
var _user$project$Components_MeasureList$initialModel = {
	priceMeasureModel: A4(_user$project$Components_PriceMeasure$Model, 'Price', 'price', 5, 0.0),
	reliabilityMeasureModel: A4(_user$project$Components_ReliabilityMeasure$Model, 'Reliability', 'reliability', 5, 0.0)
};
var _user$project$Components_MeasureList$init = {ctor: '_Tuple2', _0: _user$project$Components_MeasureList$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Components_MeasureList$MeasureListModel = F2(
	function (a, b) {
		return {priceMeasureModel: a, reliabilityMeasureModel: b};
	});
var _user$project$Components_MeasureList$ReliabilityMeasureMsg = function (a) {
	return {ctor: 'ReliabilityMeasureMsg', _0: a};
};
var _user$project$Components_MeasureList$PriceMeasureMsg = function (a) {
	return {ctor: 'PriceMeasureMsg', _0: a};
};
var _user$project$Components_MeasureList$measureRows = function (model) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$map,
			_user$project$Components_MeasureList$PriceMeasureMsg,
			_user$project$Components_PriceMeasure$view(model.priceMeasureModel)),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$map,
				_user$project$Components_MeasureList$ReliabilityMeasureMsg,
				_user$project$Components_ReliabilityMeasure$view(model.reliabilityMeasureModel)),
			_1: {ctor: '[]'}
		}
	};
};
var _user$project$Components_MeasureList$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		_user$project$Components_MeasureList$measureRows(model));
};
var _user$project$Components_MeasureList$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'PriceMeasureMsg') {
			var _p1 = A2(_user$project$Components_PriceMeasure$update, _p0._0, model.priceMeasureModel);
			var updatedPriceMeasure = _p1._0;
			var priceMeasureCmd = _p1._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{priceMeasureModel: updatedPriceMeasure}),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Components_MeasureList$PriceMeasureMsg, priceMeasureCmd)
			};
		} else {
			var _p2 = A2(_user$project$Components_ReliabilityMeasure$update, _p0._0, model.reliabilityMeasureModel);
			var updatedReliabilityMeasure = _p2._0;
			var reliabilityMeasureCmd = _p2._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{reliabilityMeasureModel: updatedReliabilityMeasure}),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Components_MeasureList$ReliabilityMeasureMsg, reliabilityMeasureCmd)
			};
		}
	});
